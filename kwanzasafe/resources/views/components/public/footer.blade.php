    ...
    <div class="ks-container">
        <div class="ksf__grid">
            <div>
                ...
                <div style="margin-top:1.25rem; font-size:0.8rem; line-height:1.7; color:#a3a3a3;">
                    <div style="color:#d4d4d4; font-weight:600;">Operado por Tec Digital (SU), LDA</div>
                    <div>NIF: 5001241206</div>
                    <div>Huambo, Cidade Alta, Largo Wassanjuca, Angola</div>
                    <div>Telefone: <a href="tel:+244922279603" style="color:#a3a3a3; text-decoration:none;">+244 922 279 603</a></div>
                    <div>E-mail: <a href="mailto:geral@kwanzasafe.com" style="color:#a3a3a3; text-decoration:none;">geral@kwanzasafe.com</a></div>
                    <div>Website: <a href="https://kwanzasafe.com" style="color:#a3a3a3; text-decoration:none;">https://kwanzasafe.com</a></div>
                </div>
            </div>
        ...
        <div style="border-top:1px solid rgba(255,255,255,0.08); margin-top:1.5rem; padding-top:1.25rem; font-size:0.75rem; color:#8a8a8a; line-height:1.6; text-align:center;">
            Empresa legalmente constituída em Angola • KYC/AML Compliance • Infraestrutura financeira em parceria com provedores licenciados
        </div>
        <div class="ksf__bottom">
            <div class="ksf__copy">© {{ date('Y') }} KwanzaSafe Wallet. Todos os direitos reservados.</div>
