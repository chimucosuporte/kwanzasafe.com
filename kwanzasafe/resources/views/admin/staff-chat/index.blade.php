...
.st-logo { height:28px; filter:brightness(0) invert(1); }
...
<header class="st-topbar">
    ...
    <div style="display:flex;align-items:center;gap:0.625rem;">
        <img src="{{ asset('assets/images/logos/logo1.png') }}" alt="KwanzaSafe" class="st-logo">
        <span class="st-title">Canal de Staff</span>
    </div>
