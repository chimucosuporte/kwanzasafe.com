...
.msg-topbar { background:#000; color:white; padding:0.875rem 1.5rem; display:flex; align-items:center; justify-content:space-between; position:sticky; top:0; z-index:50; }
...
.msg-logo { height:28px; filter:brightness(0) invert(1); }
...
<header class="msg-topbar">
    <a href="{{ route('admin.dashboard') }}" class="msg-back">
    ...
    <div style="display:flex;align-items:center;gap:0.625rem;">
        <img src="{{ asset('assets/images/logos/logo1.png') }}" alt="KwanzaSafe" class="msg-logo">
        <span class="msg-title">Mensagens Por Ler</span>
    </div>
            ...
            <a href="{{ route('admin.transaction.show', $tx->id) }}" class="msg-card">
                <div class="msg-card__avatar">
                    @if(ks_file(optional($tx->user)->profile_photo_path))
                        <img src="{{ ks_file($tx->user->profile_photo_path) }}" alt="">
                    @else
