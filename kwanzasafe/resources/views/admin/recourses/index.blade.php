...
.rc-logo { height:28px; filter:brightness(0) invert(1); }
...
<header class="rc-topbar">
    <a href="{{ route('admin.dashboard') }}" class="rc-back">
    ...
    <div style="display:flex;align-items:center;gap:0.625rem;">
        <img src="{{ asset('assets/images/logos/logo1.png') }}" alt="KwanzaSafe" class="rc-logo">
        <span class="rc-title">Recursos</span>
    </div>
    <div style="font-size:0.7rem;color:#a3a3a3;">{{ count($active) }} activo(s)</div>
</header>
